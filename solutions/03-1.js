...
(function(){
  // should be 159 - N? for some reason I get 157 - EDIT: didn't originally account for wires that crossed themselves. Excluded this and it works now
  ...
  function drawPaths(startX, startY) {
    ...
    function loopInput(inputId, input) {
      let x = startX;
      let y = startY;
